      ...
      <div className="card">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.5rem' }}>
          ...
          <div style={{ background: 'var(--bg-secondary)', padding: '1.25rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)' }}>
            ...
            <div className="grid-3 mt-3" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.5rem' }}>
              <button onClick={handleSave} className="btn btn-success btn-full" style={{ fontSize: '0.8rem', padding: '0.55rem' }}>💾 Save</button>
              <button onClick={() => downloadResumePDF('resume-preview-sheet', formData.name)} className="btn btn-primary btn-full" style={{ fontSize: '0.8rem', padding: '0.55rem', background: 'linear-gradient(135deg, #059669, #10b981)', border: 'none', fontWeight: '700' }}>📄 PDF</button>
              <button onClick={handleDownloadText} className="btn btn-outline btn-full" style={{ fontSize: '0.8rem', padding: '0.55rem' }}>📥 TXT</button>
            </div>
          </div>

          {/* Live Resume Sheet Preview */}
          <div id="resume-preview-sheet" style={{
